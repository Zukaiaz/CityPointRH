...
namespace CityPoint_RoomHire.Controllers
{
    public class EquipmentBookingsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["VenueBookingsId"] = new SelectList(_context.VenueBookings, "VenueBookingsId", "VenueBookingsId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("EquipmentBookingsId,VenueBookingsId,EquipmentHireId,Quantity")] EquipmentBookings equipmentBookings)
        {
            ...
            ViewData["EquipmentHireId"] = new SelectList(_context.EquipmentHire, "EquipmentHireId", "EquipmentHireId", equipmentBookings.EquipmentHireId);
            ViewData["VenueBookingsId"] = new SelectList(_context.VenueBookings, "VenueBookingsId", "VenueBookingsId", equipmentBookings.VenueBookingsId);
            return View(equipmentBookings);
        }

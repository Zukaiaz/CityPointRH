...
namespace CityPoint_RoomHire.Controllers
{
    public class VenueEquipmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VenueEquipmentId,VenueId,EquipmentHireId,IsIncluded")] VenueEquipment venueEquipment)
        {
            ...
            ViewData["EquipmentHireId"] = new SelectList(_context.Set<EquipmentHire>(), "EquipmentHireId", "EquipmentHireId", venueEquipment.EquipmentHireId);
            ViewData["VenueId"] = new SelectList(_context.Venues, "VenuesId", "VenuesId", venueEquipment.VenueId);
            return View(venueEquipment);
        }
